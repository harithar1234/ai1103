...
Number of elements of set X = $|X|$=2\\
Number of elements of set Y = $|Y|$=20\\

Total number of possible functions defined X to Y=Number of elements of set F=$|F|$.\\
